...
class Video {
        ...
        return new Promise((success, fail) => {
            request.put({
                ...
                formData: {
                    ...
                    redditPostId: this.redditPostId,
                    video: {
                        value: fs_1.default.createReadStream(this.processingPath),
                        options: {
                            filename: fileName,
    ...
    reply(message) {
        ...
        return this.post.reply(util_1.default.format("%s\n\n`%s`\n\nThat's robot for [share your thoughts](https://reddit.com/message/compose/?to=Clutch_22&subject=a-mirror-bot%20feedback) or [want to see my programming?](https://github.com/kyleratti/a-mirror)", message, robotSpeak));
    }
    /**
